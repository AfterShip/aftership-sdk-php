...
if ($debug || $action == 'trackings_create') {
...
if ($debug || $action == 'trackings_delete') {
...
if ($debug || $action == 'trackings_delete_by_id') {
...
if ($debug || $action == 'trackings_get_all') {
...
if ($debug || $action == 'trackings_update') {
...
if ($debug || $action == 'trackings_update_by_id') {
...
if ($debug || $action == 'trackings_retrack') {
...
if ($debug || $action == 'trackings_retrack_by_id') {
